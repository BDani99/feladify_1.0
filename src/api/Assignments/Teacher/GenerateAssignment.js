...
export const previewAssignment = async (title, subject, difficulty, className, questionTypes, selectedTopics, topicSpecification) => {
    const response = await fetch(`${API_BASE_URL}/assignments/teacher/preview`, {
        ...
        body: JSON.stringify({ title, subject, difficulty, className, questionTypes, selectedTopics, topicSpecification }),
    });
